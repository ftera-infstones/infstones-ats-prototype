    ...
    stageFeedback: {
      ...
      's3': {
        ...
        'iv6': {
          score: 3,
          questions: [
            { question: '1.1 What important design-impacting recommendations have you proposed in a project\'s technical solution? [10 Points]', feedback: 'The recommendation had a moderate impact on the design of the technical solution: 6 Points', comment: 'Candidate mentioned optimizing test environment setup but lacked details on business impact.' },
            { question: '1.2 Please describe a critical test point you designed that was proven to detect a major bug before go-live. [10 Points]', feedback: 'The described test point detected and prevented a blocking-level bug before go-live: 10 Points', comment: 'Caught a critical payment flow regression. Clear and well-structured answer.' },
            { question: '1.3 In the project, how did you identify a hidden risk point that even the product manager did not anticipate? [10 Points]', feedback: 'Has a deep understanding of the project\'s business context; the identified risk point is hidden, but it does not have a significant impact on the business: 6 Points' },
            { question: '2.1 What problems have you solved that others were unable to resolve? [5 Points]', feedback: 'Solved technical problems that others could not, resulting in a significant improvement in product quality or team efficiency: 5 Points', comment: 'Resolved a long-standing flaky test infrastructure issue that had blocked the team for months.' },
            { question: '2.2 Please provide an example to illustrate how you improved the team\'s overall quality assurance system. [5 Points]', feedback: 'The example demonstrates a moderate improvement to the team\'s overall quality assurance system: 3 Points' },
            { question: '3.1 When encountering an urgent production issue, how do you quickly locate the problem? [5 Points]', feedback: 'Clearly describes the approach to locating the issue and is able to summarize it into a methodology: 5 Points', comment: 'Has a clear triage methodology: logs → metrics → traces. Very systematic.' },
            { question: '3.2 Have you ever encountered a severe production incident? How did you handle it? [10 Points]', feedback: 'Clearly describes the symptoms and impact of the production incident, as well as the resolution approach and outcome, but partially overlooks investigating the root cause of the incident: 6 Points' },
            { question: '3.3 Based on the severe production incident you just described, how would you prevent it? [5 Points]', feedback: 'Able to propose an appropriate solution to prevent the incident, but shows insufficient analysis of the root cause and lacks depth in considering the potential impact scope and other related risk points: 3 Points', comment: 'Prevention plan was surface-level. Could improve on root cause analysis depth.' },
            { question: '4.1 What kind of QA do you consider a good QA? What kind of QA do you dislike the most? [15 Points]', feedback: 'Demonstrates all key qualities, including accountability, efficiency, strong communication skills, a passion for learning, and a high level of proactiveness: 15 Points', comment: 'Excellent answer. Emphasized ownership and cross-team communication. Aligns well with our culture.' },
            { question: '5.1 Please design test cases for the My Project module. [10 Points]', feedback: 'The test cases fully cover all positive scenarios and the important negative scenarios: 6 Points' },
            { question: '5.2 Please identify and describe the business risk points of the My Plan module. [15 Points]', feedback: 'Able to quickly and accurately understand the business, and identify correct business risk points: 10 Points', comment: 'Identified subscription renewal race conditions and downgrade edge cases. Solid business thinking.' },
          ],
        },
      },
    },
